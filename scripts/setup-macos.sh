...
sudo scutil --set ComputerName "irvine-mbp"
sudo scutil --set HostName "irvine-mbp"
sudo scutil --set LocalHostName "irvine-mbp"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "irvine-mbp"
